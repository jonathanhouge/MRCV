...
def cli_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "set the filename of the output CSV(s). Default output is a CSV file with the same name as its respective list.\n"
    ...
    parser.add_argument(
        ...
        required=False,
        default="academy-ballots/animated-short",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "only scrape selected pages from a URL. Default is to scrape all pages.\n"
    ...
    parser.add_argument(
        ...
        nargs="*",
        help=(
            "the Letterboxd URL of the list that should be scraped. Multiple URLs can be given, separated by a space. For example:\n\n"
